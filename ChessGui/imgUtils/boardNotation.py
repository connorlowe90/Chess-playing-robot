...
chessboard = ['a8', 'b8', 'c8', 'd8', 'e8', 'f8', 'g8', 'h8',
		 ...
		 'rrr1', 'nnn1', 'bbb1', 'qqq1', 'kkk1', 'bbb2', 'nnn2', 'rrr2',
		 'qqq2']
...
# checks to see if a piece is captured 
def check_captured_moveWhite(move, board):
    moveArray = []
    moveArray2 = []
    print(move)
    ...
    if (pieceCap != None):
		...
		# ending position
		capBlack.append(pieceCap)
		count = getPieceIter(pieceCap, capBlack)
		endPosition = str(pieceCap) + str(pieceCap) + str(pieceCap) + str(count)
