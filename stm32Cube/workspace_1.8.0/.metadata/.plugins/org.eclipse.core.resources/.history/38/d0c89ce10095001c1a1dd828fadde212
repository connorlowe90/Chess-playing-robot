...
//	getMessage(buffer);
//
//	char data1[] = "Message received: ";
//	printMessage(data1);
//
//	printMessage(buffer);
//
//	char data2[] = "END OF MESSAGE \r\n";
//	printMessage(data2);


//	BoardCal();
//	HAL_UART_Receive_DMA(&huart3, (uint8_t*) messageBuffer, 7);
